...
<!-- ===================== PROJECT PAIR 1 (Interlinked + A Small Impact) ===================== -->

| [Interlinked](https://malootter.itch.io/interlinked) | [A Small Impact](https://pimodorf16.itch.io/a-small-impact) |
| :-----------: | :---------: |
| <img width="100%" src="https://github.com/Daappoy/Interlinked/blob/main/Assets/Videos/GIFS/Dialogue.gif" alt="interlinked-preview" /> | <img width="100%" src="https://github.com/Daappoy/Gemastik25/blob/main/Assets/GIFS/ezgif.com-video-to-gif-converter.gif" alt="asmallimpact-preview" /> |
| A Papers Please–like game where you and your AI companion determine whether people or AIs in the city are stable and safe. | A platformer where you play as three robots working together to restore the city's power. |
| Implemented dialogue system, minigame popups, and scoring system. Built supporting systems for gameplay flow and balancing. | Implemented gameplay systems and mechanics for multi-character platforming and puzzle flow. |
| Hours worked: ~30 hours | Hours worked: ~55 hours |
...
<!-- ===================== PROJECT PAIR 2 (Out of the Box + Felix's Notebook) ===================== -->

| [Out of the Box](https://randomhunter33.itch.io/outofthebox) | [Felix's Notebook](https://thehoodedhood.itch.io/felixs-notebook) |
| :---------: | :-----------------: |
...
[![Email](https://custom-icon-badges.demolab.com/badge/Daffa-D44638?logo=gmail&logoColor=fff)](mailto:m.alghifaridaffa@gmail.com)<br/>
